<x-guest-layout>
    <x-auth-card>
            <a href="/register" class="flex justify-center flex-grow py-2 my-4 text-center border rounded w-100">
                <div>
                    {{ __('Register') }}
                </div>
            </a>
        <x-slot name="logo">
            <a href="/">
                <x-application-logo class="w-20 mx-auto text-purple-900 fill-current" />
            </a>
        </x-slot>
        <!-- Session Status -->
